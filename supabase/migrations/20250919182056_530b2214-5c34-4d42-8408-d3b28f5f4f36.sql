...
-- 4. Create public read policy for quote-pdfs bucket
CREATE POLICY IF NOT EXISTS "public_read_pdfs"
ON storage.objects FOR SELECT
TO public
USING (bucket_id = 'quote-pdfs');

-- 5. Create policy for authenticated users to upload PDFs
CREATE POLICY IF NOT EXISTS "authenticated_upload_pdfs"
